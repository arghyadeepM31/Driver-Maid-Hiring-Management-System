...
{               ?>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-users purple_color"></i> <span>Maid / Driver</span></a>
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="add-maid.php">> <span>Add Maid / Driver</span></a></li>
                           <li><a href="manage-maid.php">> <span>Manage Maid / Driver</span></a></li>
                           
                        </ul>
                     </li>
                     
                     <li>
                        <a href="#apps" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-files-o blue2_color"></i> <span>Maid / Driver Hiring Request</span></a>
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="additional_page1">
                           ...
                           <li>
                              <a href="search-maid.php">> <span>Search Maid / Driver</span></a>
                           </li>
