...
<html lang="en">
   <head>
      <title>Maid / Driver Hirirng Management System || Add Maid / Driver</title>
...
<option value="<?php echo htmlentities($row2->ID);?>"><?php echo htmlentities($row2->CategoryName
 ...
 <?php } ?>
                           ...
                           <div class="field">
                              <label class="label_field">Maid / Driver ID</label>
                          ...
                          <br>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Maid / Driver Pic</label>
