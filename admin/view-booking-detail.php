...
<html lang="en">
   <head>
      ...
      <title>Maid / Driver Hiring Management System || View Maid Booking Details</title>
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2>View Maid / Driver Booking Details</h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
...
$assignto=$row->AssignTo;
             ?> 
                                   <table class="table table-bordered">
                                    <tr>
    <th colspan="6" style="color: orange;font-weight: bold;font-size: 20px;text-align: center;">Maid / Driver Booking Details </th>
  </tr>
  <tr>
    <th>Booking ID</th>
...
{
  echo "Your booking request has been approved";
}
...
{  ?>
    <tr>
        <th colspan="4" style="color:blue; font-size:20px;">Maid / Driver Details</th>
    </tr>
<tr>
    <th>Maid / Driver Name</th>
